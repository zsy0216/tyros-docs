module.exports = {
    ...
    base: '/tyros-docs/',
    head: [
        ['link', {rel: 'icon', href: 'https://img-blog.csdnimg.cn/20210724150855633.jpg'}],
        [
            "script",
            {
    ...
    themeConfig: {
        logo: 'https://img-blog.csdnimg.cn/20210724150855633.jpg',
        // displayAllHeaders: true ,
        nav: [
            {text: '指南', link: '/guide/'},
            {text: '开发手册', link: '/manual/'},
            {text: 'GitHub', link: 'https://www.gitee.com/tyros/tyros-docs'},
        ],
        sidebar: {
            '/guide/': [
                {
        ...
        // 假如你的文档仓库和项目本身不在一个仓库：
        docsRepo: 'https://www.gitee.com/tyros/tyros-docs',
        // 假如文档不是放在仓库的根目录下：
